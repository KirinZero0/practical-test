...
<template>
    <Head title="Welcome" />
    <div class="bg-sky-300 text-white">
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                >
                    <div class="flex lg:justify-center lg:col-start-2">
                        <svg
                            class="h-12 w-auto text-white lg:h-16 lg:text-[#ffffff]"
                            viewBox="0 0 62 65"
                            fill="none"
                ...
                <main class="mt-6">
                    <section class="dark:bg-sky-100 dark:text-gray-800">
                        <div
                        ...
                        >
                            ...
                            >
                                ...
                                <p class="mt-6 mb-8 text-lg sm:mb-12">
                                    i made this for a practical test
                                ...
                                >
                                    <Link
                                        :href="route('login')"
                                        class="px-8 py-3 text-lg font-semibold rounded bg-sky-400 dark:text-gray-50"
                                        >Login</Link
                                    >
                                    <Link
                                        :href="route('register')"
